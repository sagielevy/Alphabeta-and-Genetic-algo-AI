...
inline bool movesEq(const Move& a, const Move& b)
{
	return a.jump == b.jump && a.src == b.src && a.dst == b.dst;
}

inline bool movesEqReverse(const Move& a, const Move& b)
{
	return a.jump == b.jump && a.dst == b.src && a.src == b.dst;
}
